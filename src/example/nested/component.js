...
sanSSRResolver.setRenderer("0", function  (data, ...info) {
    ...
    for (let [key, val] of _.iterate(list)) {
        ...
        childSlots[""] = function  (parentCtx, data) {
            ...
            let ChildComponentClass = sanSSRResolver.getChildComponentClass({specifier: "./component2", id: "default"}, instance, "x-p", ctx.context)
            html += sanSSRResolver.getRenderer({specifier: "./component2", id: "default"}, "x-p", ctx.context)({}, {noDataOutput: true, parentCtx, tagName: "x-p", slots: childSlots1, ComponentClass: ChildComponentClass});
            ctx.data = compData;
            return html;
};
