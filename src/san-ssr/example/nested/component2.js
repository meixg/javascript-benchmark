...
sanSSRResolver.setRenderer("default", function  (data, ...info) {
    ...
    if (!sanSSRResolver.getPrototype("default")) {
        let ComponentClass = info.ComponentClass
        if (typeof ComponentClass === 'function') {
            sanSSRResolver.setPrototype("default", _.createInstanceFromClass(ComponentClass));
        }
        else {
            sanSSRResolver.setPrototype("default", ComponentClass);
        }
    };
