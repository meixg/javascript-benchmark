    ...
    for (let [key, val] of _.iterate(list)) {
        ...
        childSlots[""] = function  (parentCtx, data) {
            ...
            childSlots1[""] = function  (parentCtx, data) {
                ...
                let childSlots2 = {}
                childSlots2[""] = function  (parentCtx, data) {
                    let html = ""
                    html += "<!--s-slot-->";
                    ...
                    html += "\n                    " + _.output(ctx.data.text, true) + "\n                    ";
                    let childSlots3 = {}
                    childSlots3[""] = function  (parentCtx, data) {
                        let html = ""
                        html += "<!--s-slot-->";
                        ...
                        html += "\n                        " + _.output(ctx.data.text, true) + "\n                        ";
                        let childSlots4 = {}
                        childSlots4[""] = function  (parentCtx, data) {
                            let html = ""
                            html += "<!--s-slot-->";
                            ...
                            html += "\n                            " + _.output(ctx.data.text, true) + "\n                            ";
                            let childSlots5 = {}
                            childSlots5[""] = function  (parentCtx, data) {
                                let html = ""
                                html += "<!--s-slot-->";
                                ...
                                html += "\n                                " + _.output(ctx.data.text, true) + "\n                                ";
                                let childSlots6 = {}
                                childSlots6[""] = function  (parentCtx, data) {
                                    let html = ""
                                    html += "<!--s-slot-->";
                                    ...
                                    html += "\n                                    " + _.output(ctx.data.text, true) + "\n                                    ";
                                    let childSlots7 = {}
                                    childSlots7[""] = function  (parentCtx, data) {
                                        let html = ""
                                        html += "<!--s-slot-->";
                                        ...
                                        html += "\n                                        " + _.output(ctx.data.text, true) + "\n                                        ";
                                        let childSlots8 = {}
                                        childSlots8[""] = function  (parentCtx, data) {
                                            let html = ""
                                            html += "<!--s-slot-->";
                                        ...
                                        let ChildComponentClass = sanSSRResolver.getChildComponentClass({specifier: ".", id: "9"}, instance, "x-h", ctx.context)
                                    ...
                                    let ChildComponentClass1 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "8"}, instance, "x-g", ctx.context)
                                ...
                                let ChildComponentClass2 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "7"}, instance, "x-f", ctx.context)
                            ...
                            let ChildComponentClass3 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "6"}, instance, "x-e", ctx.context)
                        ...
                        let ChildComponentClass4 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "5"}, instance, "x-d", ctx.context)
                    ...
                    let ChildComponentClass5 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "4"}, instance, "x-c", ctx.context)
                ...
                let ChildComponentClass6 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "3"}, instance, "x-b", ctx.context)
            ...
            let ChildComponentClass7 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "2"}, instance, "x-a", ctx.context)
        ...
        let ChildComponentClass8 = sanSSRResolver.getChildComponentClass({specifier: ".", id: "1"}, instance, "x-p", ctx.context)
